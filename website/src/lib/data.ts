...
export const projects = [
  ...
  },
  {
    slug: "salonix",
    title: "Salonix",
    subtitle: "Online Salon Service Booking Platform",
    category: "Service Platform",
    industry: "Beauty & Wellness",
    role: "Product Coordinator",
    description:
      "Appointment booking system with service scheduling, availability management, and optimized customer booking flows.",
    tags: ["Booking Systems", "Service Scheduling", "Customer Flow"],
    features: [
      "Appointment Booking",
      "Service Scheduling",
      "Customer Flow",
  ...
  },
  {
    slug: "homecare",
    title: "Homecare",
    subtitle: "Medical & Healthcare Home-Service Platform",
    category: "Service Platform",
    industry: "Healthcare",
    role: "Operations Planner",
    description:
      "Home medical service platform with healthcare operational workflows, service coordination, and provider management systems.",
    tags: ["Healthcare Operations", "Service Coordination", "Compliance"],
    features: [
